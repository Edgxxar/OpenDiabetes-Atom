...
function checkDocker() {
  ...
  docker.getImage('odv').inspect(checkDockerImage);
  docker.getImage('plotteria').inspect(checkDockerImage);
}

function checkDockerImage(error) {
  if (error != null) {
...
module.exports = {
  ...
  checkDocker, checkCli, checkPlot,
  isVaultInitialized, initializeVault, executeCli, spawnCli,
