...
export default class TagInput {
  ...
  render() {
    ...
    return (
      <div className="input-tag inline-block native-key-bindings">
        <div style="display: inline-block">{this.children}</div>
        <input type="text" on={{focus: this.openList, blur: this.closeList, input: this.inputChange}} value={this.properties.value || ''} ref="input"/>
  ...
  inputChange() {
    this.onupdate(this.refs.input.value);
  }
