  ...
  render() {
    return (
      <div className="odf-toolbar block">
        ...
        <div className="btn-group inline-block">
          <input className="input-file" id="odf-open-file" type="file" accept=".odf" on={{change: this.open}}/>
          <label htmlFor="odf-open-file" className="btn btn-info icon icon-file-directory" title="Open..."/>
